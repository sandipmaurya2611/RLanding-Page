...
const services = [
  {
    ...
    desc: "Custom mobile applications for iOS and Android platforms with intuitive user interfaces.",
  },
  {
    icon: <FaGlobe className="text-purple-400 text-3xl mb-4" />,
    title: "Web Development",
    desc: "Responsive websites and web applications built with cutting-edge technologies.",
  },
  {
    icon: <FaAndroid className="text-cyan-400 text-3xl mb-4" />,
    title: "Android Development",
    desc: "Native Android applications optimized for performance and user experience.",
  },
  {
    icon: <FaCode className="text-cyan-400 text-3xl mb-4" />,
    title: "Software Development",
    desc: "Custom software solutions tailored to your specific business requirements.",
  },
  {
    icon: <FaBrain className="text-purple-400 text-3xl mb-4" />,
    title: "AI / ML Services",
    desc: "Intelligent systems and machine learning models to automate and optimize processes.",
  },
  {
    icon: <FaShieldAlt className="text-cyan-400 text-3xl mb-4" />,
    title: "Security Software",
    desc: "Robust security solutions to protect your digital assets and infrastructure.",
  },
  {
    icon: <FaCloud className="text-purple-400 text-3xl mb-4" />,
    title: "Cloud Computing",
    desc: "Scalable cloud solutions for reliable and efficient infrastructure.",
  },
  {
    icon: <FaProjectDiagram className="text-cyan-400 text-3xl mb-4" />,
    title: "API Development",
    desc: "Custom API development for seamless integration between services and apps.",
  },
  {
    icon: <FaSearch className="text-purple-400 text-3xl mb-4" />,
    title: "SEO",
    desc: "Search engine optimization strategies to improve your online visibility.",
  },
  {
...
<div className="overflow-visible pb-6">
  <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.3] bg-gradient-to-r from-purple-500 to-cyan-400 text-transparent bg-clip-text drop-shadow-sm">
    Rbrickks Technology
        ...
        <div className="fixed bottom-6 right-6 flex flex-col items-center gap-4 z-50">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h2a1 1 0 011 1v3a1 1 0 01-1 1H5v1a12 12 0 0012 12h1v-2a1 1 0 011-1h3a1 1 0 011 1v2a2 2 0 01-2 2h-2c-9.941 0-18-8.059-18-18V5z" />
            </svg>
          </a>
      ...
      <section className="bg-[#0e0e0e] text-white py-16 px-4" id="services">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-[#1a1a1a] border border-gray-700 rounded-xl p-6 hover:shadow-lg transition text-left"
              >
                {service.icon}
      ...
      <section className="bg-[#0e0e0e] text-white py-20 px-4">
        <div className="overflow-visible pb-6 mx-auto text-center">
          ...
          <p className="text-gray-400 mb-12 max-w-2xl mx-auto">
            We leverage the latest technologies to deliver high-quality solutions for our clients.
          </p>
