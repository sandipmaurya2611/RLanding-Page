...
const projects = [
  {
    ...
    description:
      "A professional dental clinic website for appointment bookings and showcasing services.",
    link: "https://lokhandesaidental.com/",
  },
  {
    name: "Practo - Bharuch Doctor",
    description:
      "Doctor profile on Practo platform for easy discovery and appointment scheduling.",
    link: "https://www.practo.com/Bharuch/doctor",
  },
  {
    name: "Aakash Institute",
    description:
      "A leading education website offering online and offline test preparation services.",
    link: "https://www.Aakash.ac.in/",
  },
  {
    name: "Ritz Carlton",
    description:
      "Luxury hotel website showcasing resorts, bookings, events, and premium services.",
    link: "https://www.ritzcarlton.com/",
  },
  {
    name: "Coursera",
    description:
      "Global online learning platform with thousands of courses from top universities.",
    link: "https://www.coursera.org/",
  },
  {
    name: "Demech India",
    description:
      "Industrial website presenting engineering services and product capabilities.",
    link: "https://demechindia.com/",
  },
  {
    name: "Business Class",
    description:
      "Travel service website for booking premium flight experiences worldwide.",
    link: "https://www.businessclass.com/",
  },
  {
    name: "SE Associates",
    description:
      "Professional consultancy website for CA services, finance, and legal solutions.",
    link: "https://www.seassociates.in/",
  },
  {
    name: "Phoenix Mecano",
    description:
      "Website for global industrial components supplier with product catalog and tech specs.",
      ...
      <nav className="fixed top-0 left-0 right-0 bg-gray-900 bg-opacity-90 z-50 shadow-md">
        ...
        {menuOpen && (
          <div className="md:hidden px-6 pb-4 space-y-3">
            <button
              onClick={() => scrollToSection(aboutRef)}
              className="block w-full text-middle hover:text-purple-400"
            >
              About
            </button>
            <button
            ...
            <a
              href="/"
              className="inline-block bg-gradient-to-r from-purple-400 to-cyan-400 px-6 py-2 rounded-full text-white font-semibold w-full text-center"
            >
              Get More Services
            </a>
          </div>
      ...
      <div className="pt-24">
        <div className="flex flex-col items-center justify-center text-center py-20 px-4">
          ...
          <p className="text-gray-400 max-w-xl">
            Explore our collection of high-performing websites developed by the
            Rbrickks team using modern technologies and sleek designs.
          </p>
        ...
        <section ref={projectsRef} className="px-6 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {projects.map((project, index) => (
              ...
              >
                <h4 className="text-xl font-semibold text-lime-300 mb-2">
                  {project.name}
                </h4>
        ...
        <section ref={contactRef} className="px-6 py-20 bg-gray-900">
          ...
          <div className="max-w-xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg">
            <form ref={form} onSubmit={sendEmail} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-500 to-cyan-400 py-3 rounded-md text-white font-semibold hover:opacity-90 transition"
              >
                Send Message
              </button>
            </form>
...
{/* floating icons */}
  ...
  <a
    ...
    className="bg-purple-600 p-4 md:p-5 rounded-full shadow-lg hover:scale-110 transition"
  >
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="bg-green-500 p-4 md:p-5 rounded-full shadow-lg hover:scale-110 transition"
  >
