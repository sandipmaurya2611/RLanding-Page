    ...
    <div className="bg-black min-h-screen text-white font-sans relative">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-gray-900 bg-opacity-90 z-50 flex items-center justify-between px-6 py-4 shadow-md">
        ...
        <div className="flex justify-center gap-6">
          ...
          <button onClick={() => scrollToSection(projectsRef)} className="text-white hover:text-purple-400 transition">Projects</button>
          ...
          <div className="max-w-xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg">
            <form className="space-y-6">
              <div>
                ...
                <input type="text" placeholder="Your Name" className="w-full p-3 rounded-md bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-purple-500" />
              </div>
              <div>
                <label className="block text-gray-300 text-sm mb-2">Email</label>
                <input type="email" placeholder="you@example.com" className="w-full p-3 rounded-md bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-purple-500" />
              </div>
              <div>
                <label className="block text-gray-300 text-sm mb-2">Message</label>
                <textarea rows="4" placeholder="Your Message" className="w-full p-3 rounded-md bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-purple-500" />
              </div>
              <button type="submit" className="w-full bg-gradient-to-r from-purple-500 to-cyan-400 py-3 rounded-md text-white font-semibold hover:opacity-90 transition">
                Send Message
              </button>
            </form>
          </div>
