    ...
    <div className="bg-black min-h-screen text-white font-sans relative">
      <nav className="fixed top-0 left-0 right-0 bg-gray-900 bg-opacity-90 z-50 shadow-md">
        <div className="flex items-center justify-between px-4 sm:px-6 py-4">
          <div className="text-white text-lg font-bold">Rbrickks Tech</div>
          ...
          <div className="hidden sm:flex gap-6">
            ...
            <button onClick={() => scrollToSection(ContactPage)} className="hover:text-purple-400">Contact</button>
          </div>
          <div className="hidden sm:block">
            <a
              href="/"
              className="bg-gradient-to-r from-purple-400 to-cyan-400 px-4 py-2 rounded-full text-sm font-semibold"
            >
              Get More Services
            </a>
          </div>
      ...
      <div className="pt-28 sm:pt-24">
        <section className="text-center py-20 px-4">
          ...
          <div className="mt-8 bg-gradient-to-r from-purple-400 to-cyan-400 px-4 py-2 rounded-full text-white text-sm sm:text-base font-semibold">
        ...
        <section ref={aboutRef} className="px-4 sm:px-6 py-20 text-center">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto leading-relaxed text-sm sm:text-base">
            <strong>Rbrickks Technology Pvt. Ltd.</strong>, founded on 13th September 2022 by Mr. Rohan Prashant Kolhe, is a Pune-based IT company committed to connecting people with the digital future.
            With the tagline <span className="text-purple-400 font-semibold">"Let’s Connect With Digital Future,"</span>
            we specialize in custom software, cloud solutions, AI/ML integration, and IT services.
            <br /><br />
