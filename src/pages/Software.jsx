  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans relative">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
        <a href="tel:+7249400874" className="bg-green-500 p-3 rounded-full text-white shadow-lg hover:scale-110 transition">
          <FiPhoneCall size={24} />
        </a>
        <a href="https://wa.me/7249400874" target="_blank" rel="noopener noreferrer" className="bg-green-600 p-3 rounded-full text-white shadow-lg hover:scale-110 transition">
          <BsWhatsapp size={24} />
        </a>
      </div>
    </div>
